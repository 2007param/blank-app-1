...
def title_page():
    ...
    st.markdown("<p style='text-align: center;'>If you have any questions or feedback about our AI tutorial, please don't hesitate to contact us.</p>")
    st.markdown("<p style='text-align: center;'>Email: ai-tutorial@example.com</p>")
    st.markdown("<p style='text-align: center;'>Phone: (123)-456-7890</p>")
    st.markdown("<p style='text-align: center;'>© 2024 Bioinformatics Tutorial for High Schoolers</p>")
